...
namespace Nsg.Viewer.OSXWindow
{
    ...
    public struct MTLRenderPipelineColorAttachmentDescriptor
    {
        ...
        {
            get => ObjectiveCRuntime.bool8_objc_msgSend(NativePtr, sel_isBlendingEnabled);
            set => ObjectiveCRuntime.objc_msgSend(NativePtr, sel_setBlendingEnabled, value);
        }

        public MTLBlendOperation alphaBlendOperation
        {
            get => (MTLBlendOperation)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_alphaBlendOperation);
        ...
        {
            get => (MTLBlendOperation)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_rgbBlendOperation);
        ...
        {
            get => (MTLBlendFactor)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_destinationAlphaBlendFactor);
        ...
        {
            get => (MTLBlendFactor)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_destinationRGBBlendFactor);
        ...
        {
            get => (MTLBlendFactor)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_sourceAlphaBlendFactor);
        ...
        {
            get => (MTLBlendFactor)ObjectiveCRuntime.uint_objc_msgSend(NativePtr, sel_sourceRGBBlendFactor);
