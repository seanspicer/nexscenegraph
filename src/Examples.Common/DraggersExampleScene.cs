...
namespace Examples.Common
{
    public class DraggersExampleScene
    {
        public static IGroup Build()
        {
            ...
            var scale2DDraggerXForm =
                MatrixTransform.Create(Matrix4x4.CreateTranslation(1f, -1.0f, 0.0f)); //(1f, -1.0f, 0.0f));
            ...
            var translatePlaneDraggerXForm =
                MatrixTransform.Create(Matrix4x4.CreateTranslation(1f, 1.0f, 2.0f)); //(1f, 1.0f, 2.0f)
