...
namespace Veldrid.SceneGraph.Wpf.Element
{
    public class D3D11 : D3D
    {
        ...
        public override void Reset(int w, int h)
        {
            ...
            Set(ref m_renderTarget, new SharpDX.Direct3D11.Texture2D(this.m_device, desc));
            ...
            m_device.ImmediateContext.Rasterizer.SetViewport(0, 0, w, h, 0.0f, 1.0f);
        ...
        /// 
        /// </summary>
        public SharpDX.Direct3D11.Texture2D RenderTarget { get { return Prepared(ref m_renderTarget); } }
        ...
        /// 
        /// </summary>
        public SharpDX.Direct3D11.Texture2D DepthStencil { get { return Prepared(ref m_depthStencil); } }
        ...
        protected SharpDX.Direct3D11.Texture2D m_renderTarget;
        protected RenderTargetView m_renderTargetView;
        protected SharpDX.Direct3D11.Texture2D m_depthStencil;
