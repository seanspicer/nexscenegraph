...
namespace Veldrid.SceneGraph.Wpf.Element
{
    public static class DXSharing
    {
        ...
        public static SharpDX.Direct3D9.Texture GetSharedD3D9(this DeviceEx device, SharpDX.Direct3D11.Texture2D renderTarget)
        {
            ...
            using (var resource = renderTarget.QueryInterface<SharpDX.DXGI.Resource>())
            {
                ...
                return new SharpDX.Direct3D9.Texture(device, renderTarget.Description.Width, renderTarget.Description.Height, 1, Usage.RenderTarget, format, Pool.Default, ref handle);
            }
        }
