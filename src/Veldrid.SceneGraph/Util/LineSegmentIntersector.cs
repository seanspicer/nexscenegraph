...
namespace Veldrid.SceneGraph.Util
{
    ...
    {
        public LineSegmentIntersector _lineSegmentIntersector { get; set; }
        public IIntersectionVisitor _iv { get; set; }
        public IDrawable _drawable { get; set; }
        public bool _limitOneIntersection { get; set; }
    }
    ...
    public class LineSegmentIntersectFunctorDelegate : IPrimitiveFunctorDelegate, IIntersectFunctor
    {
        ...
        public uint _primitiveIndex { get; set; }
        ...
        public float _inverse_length { get; set; }
        ...
        private bool enter(IBoundingBox bb)
        {
        ...
        private void Intersect(Vector3 v0, Vector3 v1, Vector3 v2)
        {
            ...
            var hit = new LineSegmentIntersector.Intersection();
    ...
    public class LineSegmentIntersector : Intersector, ILineSegmentIntersector
    {
        ...
        protected LineSegmentIntersector(Vector3 start, Vector3 end,
            IIntersector.IntersectionLimitModes intersectionLimit)
        ...
        protected LineSegmentIntersector Parent { get; set; }

        public SortedMultiSet<ILineSegmentIntersector.IIntersection> Intersections { get; } =
            new SortedMultiSet<ILineSegmentIntersector.IIntersection>();
        ...
        protected void Intersect(IIntersectionVisitor iv, IDrawable drawable, Vector3 s, Vector3 e)
        {
            ...
            settings._limitOneIntersection =
                IntersectionLimit == IIntersector.IntersectionLimitModes.LimitOnePerDrawable ||
                IntersectionLimit == IIntersector.IntersectionLimitModes.LimitOne;
        ...
        protected virtual bool Intersects(IBoundingSphere bs)
        {
            ...
            var c = startToCenter.LengthSquared() - System.Math.Pow(bs.Radius, 2);
            ...
            var b = Vector3.Dot(startToCenter, startToEnd) * 2.0;
        ...
        {
            if (null != Parent) return Parent.Intersections;

            return Intersections;
        }

        public class Intersection : IComparable<ILineSegmentIntersector.IIntersection>,
            ILineSegmentIntersector.IIntersection
        {
