...
namespace Veldrid.SceneGraph.Util.Shape
{
    ...
    {
        private const uint MIN_NUM_ROWS = 3;
        private const uint MIN_NUM_SEGMENTS = 5;
            ...
            ISphere sphere)
        {
            ...
            if (colors.Length < 1) throw new ArgumentException("Must provide at least one color for spheres");
            ...
            var lDelta = (float) System.Math.PI / numRows;
            var vDelta = 1.0f / numRows;
