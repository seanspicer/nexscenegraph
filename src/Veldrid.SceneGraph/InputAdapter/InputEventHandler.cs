...
namespace Veldrid.SceneGraph.InputAdapter
{
    public abstract class InputEventHandler : IInputEventHandler
    {
        ...
        {
            var xNorm = 2.0f * (InputStateTracker.MousePosition.Value.X / InputStateTracker.FrameSnapshot.WindowWidth) -
                        1.0f;
            var yNorm =
                -2.0f * (InputStateTracker.MousePosition.Value.Y / InputStateTracker.FrameSnapshot.WindowHeight) + 1.0f;
