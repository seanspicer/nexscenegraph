...
namespace Veldrid.SceneGraph
{
    ...
    public struct Matrix4x4d
    {
        ...
        [System.Security.SecuritySafeCritical]
        public static bool Decompose(Matrix4x4d matrix, out Vector3d scale, out Quaternion rotation, out Vector3d translation)
        {
            bool result = true;
            ...
            unsafe
            {
                fixed (Vector3d* scaleBase = &scale)
                {
                    ...
                    Vector3d** pVectorBasis = (Vector3d**)&vectorBasis;

                    Matrix4x4d matTemp = Matrix4x4d.Identity;
                    CanonicalBasis canonicalBasis = new CanonicalBasis();
                    Vector3d* pCanonicalBasis = &canonicalBasis.Row0;
