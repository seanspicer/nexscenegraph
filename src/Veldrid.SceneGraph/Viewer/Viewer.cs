...
namespace Veldrid.SceneGraph.Viewer
{
    public class Viewer : ViewerBase, IViewer
    {
        ...
        public bool ComputeIntersections(IUiEventAdapter eventAdapter,
            ref SortedMultiSet<ILineSegmentIntersector.IIntersection> intersections, uint traversalMask)
        {
            throw new NotImplementedException();
        }
        ...
        protected override ContextList GetContexts(bool onlyValid)
        {
            ...
            if (Camera != null && (null != Camera.GraphicsContext || !onlyValid)) contexts.Add(Camera.GraphicsContext);
