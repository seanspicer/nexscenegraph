...
namespace MultiControlExample.Wpf
{
    ...
    {
        public SceneViewModel SceneViewModel1 { get; } = new SceneViewModel();
        public SceneViewModel SceneViewModel2 { get; } = new SceneViewModel();
    }
    
    public class SceneViewModel : ViewModelBase
    {
        public SceneViewModel() : base()
        {
