...
namespace Veldrid.SceneGraph.Tests
{
    ...
    public class UtilMathShould
    {
            ...
            float by, float bz)
        {
            ...
            var r = SceneGraph.Util.Math.CalculateRotationBetweenVectors(a, b);
        ...
        public void TestCalculateTangents()
        {
            ...
            var tangents = SceneGraph.Util.Math.ComputePathTangents(trajectory);
        ...
        public void ExtrudeCylinderDoesNotThrowWithNearlyLinearPath()
        {
            ...
            Assert.DoesNotThrow(() =>
            {
                var extrusion = SceneGraph.Util.Math.ExtrudeShape(shape, path);
            });
        }
